...
- __Application__ means the software program provided by the Company downloaded by You on any electronic device, named Carta Plus
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to the developer(s) of Carta Plus.
...
- Audiobook url and related data such as book title and auther(s) name
